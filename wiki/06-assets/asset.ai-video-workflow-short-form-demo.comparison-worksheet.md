...
primary_pages: ["workflow"]
conversion_event: "download_shortlist"
...
It gives the visitor a concrete next step from workflow.
...
- Strongest path: workflow -> comparison-worksheet
- Submit rate: 28%
- Delivery rate: 23.5%
- Deeper action rate: 9.9%
